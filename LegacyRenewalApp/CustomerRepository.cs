...
namespace LegacyRenewalApp
{
    public class CustomerRepository :  IRepository
    {
        ...
        {
            { 1, new Customer { Id = 1, FullName = "Anna Kowalska", Email = "anna.kowalska@example.com", Segment = "Education", Country = "Poland", YearsWithCompany = 1, LoyaltyPoints = 20, IsActive = true } },
        ...
        {
            return GetById(Convert.ToInt32(value));
        }
